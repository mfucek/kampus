	...
	return (
		<main className="min-h-screen bg-section py-20 flex flex-col items-center">
			<Container>
				...
				<p>
					This Privacy Notice for Wireframe Studio d.o.o. (doing business as
					Wireframe Studio) ( &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;
				...
				<p>
					<ul>
						<li>
							Visit our website at http://www.kampus.hr , or any website of ours
				...
				<p>
					...
					contact us at info@wireframe.hr. making decisions about how your
				...
				<h2 className="title-1">SUMMARY OF KEY POINTS</h2>
				<p>
					...
					may be considered &quot;special&quot; or &quot;sensitive&quot; in
					...
					personal information. Do we collect any information from third
					parties? We do not collect any information from third parties. How do
				...
				<ol>
					...
					<li>CAN YOU CONTACT US ABOUT THIS NOTICE?</li>
					<li>
						HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
					</li>
				</ol>

				<h2 className="title-1">1. WHAT INFORMATION DO WE COLLECT?</h2>

				<h3 className="title-2">Personal information you disclose to us</h3>
				...
				<p>
					...
					notice link(s) here: https://stripe.com/en-hr/privacy .
				</p>
				...
				<p>
					...
					Notice: http://www.kampus.hr/legal/cookie-policy .
				</p>
				...
				<p>
					Google API Our use of information received from Google APIs will
					adhere to Google API Services User Data Policy , including the Limited
					Use requirements.
				</p>

				<h2 className="title-1">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
				...
				<p>
					...
					apart from us. They also commit to pr otect the data they hold on our
				...
				<p>
					...
					<ul>
						<li>
							Advertising, Direct Marketing, and Lead Generation Facebook
							Audience Network and Google AdSense
						</li>

						<li>
							AI Service Providers OpenAI Allow Users to Connect to Their
							Third-Party Accounts Google account and Apple account
						</li>
						<li>
						...
						<li>Social Media Sharing and Advertising Facebook advertising</li>

						<li>
							User Account Registration and Authentication Clerk , Google
							Sign-In and Apple Sign-In
						</li>

						<li>Web and Mobile Analytics Posthog</li>

						<li>Website Performance Monitoring Vercel</li>
					</ul>
				</p>
				<p>
				...
				<p>
					...
					http://www.kampus.hr/legal/cookie-policy .
				</p>
				...
				<p>
					...
					(collectively, &quot; AI Products &quot; ). These tools are designed
					to enhance your experience and provide you with innovative solutions.
					The terms in this Privacy Notice govern your use of the AI Products
					within our Services. Use of AI Technologies We provide the AI Products
					through third-party service providers ( &quot; AI Service Providers
					&quot; ), including OpenAI . As outlined in this Privacy Notice, your
					...
					AI Products in any way that violates the terms or policies of any AI
					Service Provider.
				</p>
				<p>Our AI Products</p>
				<p>
				...
				<h2 className="title-1">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
				...
				<h2 className="title-1">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
				...
				<h2 className="title-1">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
				...
				<h2 className="title-1">10. DO WE COLLECT INFORMATION FROM MINORS?</h2>
				...
				<p>
					...
					please contact us at info@wireframe.hr .
				</p>

				<h2 className="title-1">11. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
				...
				<p>
					...
					YOU CONTACT US ABOUT THIS NOTICE? &apos; below or updating your
					preferences .
				</p>
				<p>
				...
				<p>
					...
					HOW CAN YOU CONTACT US ABOUT THIS NOTICE? &apos; below. You will then
					be removed from the marketing lists. However, we may still communicate
				...
				<p>
					...
					Cookie Notice: http://www.kampus.hr/legal/cookie-policy .
				</p>
				<p>
					If you have questions or comments about your privacy rights, you may
					email us at info@wireframe.hr.
				</p>

				<h2 className="title-1">12. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
				...
				<h2 className="title-1">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
				...
				<p>
					...
					at info@wireframe.hr or contact us by post at:
				</p>
				<p>
					Wireframe Studio d.o.o. Nežićeva 2F Zagreb , Grad Zagreb 10010 Croatia
				</p>
