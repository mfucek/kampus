...
const Page = () => {
	return (
		<main className="min-h-screen bg-section py-20 flex flex-col items-center">
			<Container>
				<h1>TERMS OF SERVICE</h1>
				<p>Last updated October 23, 2024</p>
				<p>AGREEMENT TO OUR LEGAL TERMS</p>
				<p>
					We are Wireframe Studio d.o.o. (&quot;Company,&quot; &quot;we,&quot;
					&quot;us,&quot; &quot;our&quot;).
				</p>
				<p>
				...
				<p>
					You can contact us by email at info@kampus.hr or by mail to Nežićeva
					2F, 10010 Zagreb, Croatia.
				</p>
				<p>
					These Legal Terms constitute a legally binding agreement made between
					you, whether personally or on behalf of an entity (&quot;you&quot;),
					and us, concerning your access to and use of the Services. You agree
					...
					SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.Supplemental terms
					...
					are posted.We recommend that you print a copy of these Legal Terms for
					your records.
				</p>
				<h3 className="title-3">TABLE OF CONTENTS</h3>
				<p>
					1. OUR SERVICES 2. INTELLECTUAL PROPERTY RIGHTS 3. USER
					REPRESENTATIONS 4. PROHIBITED ACTIVITIES 5. USER GENERATED
					CONTRIBUTIONS 6. CONTRIBUTION LICENSE 7. SERVICES MANAGEMENT 8. TERM
					AND TERMINATION 9. MODIFICATIONS AND INTERRUPTIONS 10. GOVERNING LAW
					11. DISPUTE RESOLUTION 12. CORRECTIONS 13. DISCLAIMER 14. LIMITATIONS
					OF LIABILITY 15. INDEMNIFICATION 16. USER DATA 17. ELECTRONIC
					COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 18. MISCELLANEOUS 19.
					CONTACT US
				</p>
				<h2 className="title-1">1. OUR SERVICES</h2>
				<p>
				...
				<h2 className="title-1">2. INTELLECTUAL PROPERTY RIGHTS</h2>
				<p>
					Our intellectual propertyWe are the owner or the licensee of all
					...
					the &quot;Content&quot;), as well as the trademarks, service marks,
					and logos contained therein (the &quot;Marks&quot;).Our Content and
				...
				<p>
					...
					ServicesSubject to your compliance with these Legal Terms, including
					...
					non-commercial use or internal business purpose.Except as set out in
					...
					in our Legal Terms, please address your request to: info@kampus.hr. If
					...
					posting, reproducing, or displaying our Content.We reserve all rights
					not expressly granted to you in and to the Services, Content, and
					Marks.Any breach of these Intellectual Property Rights will constitute
					a material breach of our Legal Terms and your right to use our
					Services will terminate immediately.Your submissionsPlease review this
				...
				<p>
					...
					false, inaccurate, deceitful, or misleading;• to the extent
				...
				<p>
					<ol>
						<li> this section</li>
						<li> any third party&apos;s intellectual property rights, or</li>
						<li> applicable law.</li>
					</ol>
				</p>
				<h2 className="title-1">3. USER REPRESENTATIONS</h2>
				...
				<p>
					<ol>
						...
						<li>
							and your use of the Services will not violate any applicable law
							or regulation.
						</li>
					</ol>
				</p>
				...
				<h2 className="title-1">4. PROHIBITED ACTIVITIES</h2>
				<p>
				...
				<h2 className="title-1">5. USER GENERATED CONTRIBUTIONS</h2>
				<p>
				...
				<h2 className="title-1">6. CONTRIBUTION LICENSE</h2>
				<p>
				...
				<h2 className="title-1">7. SERVICES MANAGEMENT</h2>
				...
				<h2 className="title-1">8. TERM AND TERMINATION</h2>
				<p>
				...
				<h2 className="title-1">9. MODIFICATIONS AND INTERRUPTIONS</h2>
				<p>
				...
				<h2 className="title-1">10. GOVERNING LAW</h2>
				<p>
					These Legal Terms shall be governed by and defined following the laws
					of Croatia. The company and yourself irrevocably consent that the
					courts of Zagreb shall have exclusive jurisdiction to resolve any
					dispute which may arise in connection with these Legal Terms.
				</p>
				<h2 className="title-1">11. DISPUTE RESOLUTION</h2>
				<p>
					...
					a &quot;Dispute&quot; and collectively, the &quot;Disputes&quot;)
					...
					from one Party to the other Party.Binding ArbitrationAny dispute
					arising out of or in connection with these Legal Terms, including any
					...
					which, as a result of referring to it, is considered as the part of
					this clause. The number of arbitrators shall be 3. The seat, or legal
					place, or arbitration shall be Zagreb. The language of the proceedings
					shall be Croatian. The governing law of these Legal Terms shall be
					substantive law of Croatia.RestrictionsThe Parties agree that any
				...
				<h2 className="title-1">12. CORRECTIONS</h2>
				<p>
				...
				<h2 className="title-1">13. DISCLAIMER</h2>
				<p>
				...
				<h2 className="title-1">14. LIMITATIONS OF LIABILITY</h2>
				<p>
				...
				<h2 className="title-1">15. INDEMNIFICATION</h2>
				<p>
				...
				<h2 className="title-1">16. USER DATA</h2>
				<p>
				...
				<h2 className="title-1">18. MISCELLANEOUS</h2>
				<p>
				...
				<h2 className="title-1">19. CONTACT US</h2>
				<p>
