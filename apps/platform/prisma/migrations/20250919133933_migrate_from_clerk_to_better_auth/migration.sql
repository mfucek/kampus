/*
  ...
  - You are about to drop the column `accountId` on the `Permission` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "ImageFile" DROP CONSTRAINT "ImageFile_userId_fkey";

-- DropForeignKey
ALTER TABLE "Notification" DROP CONSTRAINT "Notification_recepientId_fkey";
